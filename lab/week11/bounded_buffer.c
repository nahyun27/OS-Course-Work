...
int main(void)
{
    ...
    pthread_cond_broadcast(&cond_full);  // All threads waiting on cond_full are awakened
    pthread_cond_broadcast(&cond_empty); // All threads waiting on cond_empty are awakened
